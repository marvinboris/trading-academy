...
@component('components.auth.aside.dropdown', ['name' => 'settings', 'icon' => 'fas fa-cog', 'title' => 'Settings', 'link' => url('user/settings')])
    @component('components.auth.aside.dropdown-item', ['name' => 'Change password', 'link' => route('user.settings.profile.change-password')]) @endcomponent
    ...
    @endif
    @component('components.auth.aside.dropdown-item', ['name' => 'Edit language', 'link' => route('user.settings.profile.edit-language')]) @endcomponent
@endcomponent
