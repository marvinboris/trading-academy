<footer class="py-2 px-3 bg-white text-dark border-top">
    &copy; Copyright <strong>Trading Academy</strong>. All Rights Reserved. Designed by <a href="mailto:jaris.ultio.21@gmail.com" class="font-weight-bold text-reset text-decoration-none"></a> 
</footer>
@section('scripts')
<script>
    $(function () {
