...
@component('components.auth.pages.admin.create', ['data' => $data])
<div class="col-lg-3">
    <div class="p-4 bg-white border mb-3">
        <div class="border rounded-circle embed-responsive embed-responsive-1by1 mb-3"></div>
        <div class="text-center">
            <a href="#" id="upload" data-target="{{ $data['content'][count($data['content']) - 1]['data']['name'] }}" class="text-green">Click to upload image</a>
        </div>
    </div>
