<div class="row align-items-center justify-content-between text-montserrat mb-3">
    ...
    <div class="col-lg-4 pb-2 pb-lg-0">
        <div class="bg-white-20 text-white d-flex text-white justify-content-around align-items-center font-weight-bold py-2">
            <a href="#" class="px-2 text-decoration-none text-reset"><i class="fas fa-file-excel text-green mr-2"></i>Excel</a>
            <a href="#" class="px-2 text-decoration-none text-reset"><i class="fas fa-file-pdf text-purered mr-2"></i>PDF</a>
            <a href="#" class="px-2 text-decoration-none text-reset"><i class="fas fa-file-csv text-yellow mr-2"></i>CSV</a>
