...
<form action="{{ route('admin.users.admins.store') }}" method="post">
    <div class="row">
        <div class="col-lg-9">
            ...
            @csrf
            <div class="row">
                @component('components.ui.admin.form-group', ['id' => 'name', 'type' => 'text', 'required' => 'required', 'class' => 'col-6 pr-1', 'icon' => 'fas fa-user', 'name' => 'name', 'placeholder' => 'Name']) value="{{ old('name') }}" @endcomponent
        ...
        <div class="col-lg-3">
            <div class="text-center text-montserrat px-3">
                ...
                <div><a href="{{ route('admin.users.admins.index') }}" class="btn btn-block btn-orange font-weight-bold">Cancel</a></div>
            </div>
        </div>
    </div>
</form>
