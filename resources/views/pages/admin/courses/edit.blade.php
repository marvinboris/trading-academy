...
@section('parent') <a href="{{ route('admin.courses.index') }}" class="text-green text-900">Courses List</a> @endsection
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="text-center text-montserrat px-3">
                ...
                <div><a href="{{ route('admin.courses.index') }}" class="btn btn-block btn-orange font-weight-bold">Cancel</a></div>
            </div>
        </div>
    </div>
</form>
