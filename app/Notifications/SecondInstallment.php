...
class SecondInstallment extends Notification implements ShouldQueue, ShouldBeRelevantNotification
{
    ...
    {
        return in_array((string) $this->session_student->status, ['preregistration', 'first-installment']);
    }
